...
import 'package:koon/Old/Module_Profil/profil/screens/pageProfil/monTitreDeCategorie.dart';
import 'package:koon/Screens/Module_Profil/Profil_Components/monChampDuProfil.dart';
...
class _MonProfileState extends State<MonProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    List<List<String>> contact = [cuPrenom, cuNom, cuTelFixe, cuTelPort];

    var IMC = calculIMC(_taille, _poids);
    mcImc.add(IMC);

    List<List<String>> monCorps = [mcTaille, mcPoids, mcImc];
                            ...
                            child: Container(
                              ...
                              child: IconButton(
                                ...
                                color:
                                    _photo
                                        ? Colors
                                            .white // TODO couleur du thème
                                        : Colors
                                            .black54, // TODO couleur du thème
                                onPressed:
                                    () => // TODO MonProfil => changer pdp
