...
import 'package:koon/old/Archives/SeancesArchives/afficheSeance.dart';
import 'package:koon/old/delayed_animation.dart';
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) => const maSeance(title: 'Ma Seance'),
                      ),
                    );
                  },
                ),
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: PopupMenuButton<String>(
                  ...
                  itemBuilder: (BuildContext context) {
                    return itemsDistance.map<PopupMenuItem<String>>((
                      String value,
                    ) {
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: PopupMenuButton<String>(
                  ...
                  itemBuilder: (BuildContext context) {
                    return itemsPoidsRep.map<PopupMenuItem<String>>((
                      String value,
                    ) {
                      return PopupMenuItem(value: value, child: Text(value));
                    }).toList();
              ...
              children: <Widget>[
                GestureDetector(
                  ...
                  child: Container(
                    height: 56,
                    width: 56,
                    color: _value == 0 ? Colors.grey[350] : Colors.transparent,
                    child: const Icon(
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Icon(Icons.mood, color: Colors.green),
                  ),
                ),
              ],
            ),
