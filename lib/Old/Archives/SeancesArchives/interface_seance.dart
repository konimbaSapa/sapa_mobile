                    ...
                    Expanded(
                      ...
                      child: Align(
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {},
                          child: const Text(
                            "S'inscrire à une séance du programme",
                          ), //TODO : Lien vers séance pg PEPS
                        ),
                      ),
                    ),
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            'Historique de mes dernières séances',
                          ), //TODO: faire un texte cliquable pour afficher l'historique
                          TextButton(
                            style: ButtonStyle(
                              foregroundColor: MaterialStateProperty.all<Color>(
                                Colors.teal,
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder:
                                    (context) => const maSeance(
                                      title: 'Créer une séance',
                                    ),
                              ),
                            );
                          },
                          child: const Text("Créer une séance en autonomie"),
                        ),
                      ),
                    ),
                    Expanded(
