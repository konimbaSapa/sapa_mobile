import 'package:koon/old/views/components/barFiltre.dart';
import 'package:koon/old/views/components/navigationBar.dart';
...
class _ResultatsState extends State<Resultats> {
  final List ActiviteList = [
    {'title': 'Activité 1', 'place': 'Lieu 1'},
    {'title': 'Activité 2', 'place': 'Lieu 2'},
    {'title': 'Activité 3', 'place': 'Lieu 3'},
    {'title': 'Activié  4', 'place': 'Lieu 4'},
    {'title': 'Activité 5', 'place': 'Lieu 5'},
    {'title': 'Activité 6', 'place': 'Lieu 6'},
    {'title': 'Activité 7', 'place': 'Lieu 7'},
    {'title': 'Activié  8', 'place': 'Lieu 8'},
  ];
  @override
  Widget build(BuildContext context) {
    return Container(
